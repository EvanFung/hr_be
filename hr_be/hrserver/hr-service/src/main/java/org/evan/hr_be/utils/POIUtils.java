 ...
 * https://medium.com/javarevisited/a-generic-approach-to-write-excel-using-apache-poi-17a1dfd4b98e
 * Can further improve the code by using the above link
 */
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //3. Get and configure document information
        DocumentSummaryInformation docInfo = workbook.getDocumentSummaryInformation();
        //Document category
        docInfo.setCategory("员工信息");
        //Document manager
        docInfo.setManager("evanfeng");
        //Set company information
        docInfo.setCompany("www.evanfeng.org");
        //4. Get document summary information
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //Document title
        summInfo.setTitle("员工信息表");
        //Document author
        summInfo.setAuthor("evanfeng");
        //Document comments
        summInfo.setComments("This document is generated by evanfeng");
        //5. Create style
        //Create the style of the title row
    ...
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations, List<Politicsstatus> allPoliticsstatus, List<Department> allDepartments, List<Position> allPositions, List<JobLevel> allJobLevels) {
        ...
        try {
            ...
            //2. Get the number of forms in the workbook
            ...
            for (int i = 0; i < numberOfSheets; i++) {
                ...
                for (int j = 0; j < physicalNumberOfRows; j++) {
                    ...
                    if (row == null) {
                        continue;//Prevent empty lines in the data
                    }
